...
\begin{figure}[H]
    ...
    \caption{Diagrama de Secuencia de Asignación de un Vehículo a una Plaza}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagrama de Secuencia de Creación de una Incidencia}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagrama de Secuencia de la obtención de un nuevo mecánico concurrentemente cuando un hilo lo necesita}
\end{figure}

\textbf{Flujo:}

\begin{enumerate}
\item Durante \texttt{assignVtoSlot()} y si ETA > 15 segundos, se ejecuta \texttt{obtainSecondMechanic(vid)}
...
\begin{lstlisting}
askUniqueIntID("ID cliente: ", func(n int64) bool { return g.ownerIDexists(ClientID(n)) })
\end{lstlisting}
\begin{lstlisting}
askUniqueIntID("ID mecánico: ", func(n int64) bool { return g.mechIDexists(MechanicID(n)) })
\end{lstlisting}
...
\textbf{Repositorio}: \href{https://github.com/alacoste96/Practica2}{https://github.com/alacoste96/Practica2}
